...
class ProblemData:
    def __init__(
        ...
        edge_exists: list[np.ndarray[bool]] = [],
    ) -> None: ...
    ...
    def edge_exists_matrices(self) -> list[np.ndarray[bool]]: ...
    def edge_exists(self, profile: int, frm: int, to: int) -> bool: ...
    def replace(
        self,
        ...
        edge_exists: list[np.ndarray[bool]] | None = None,
    ) -> ProblemData: ...
