...
class Solution
{
    ...
    size_t numMissingSoft_ = 0;     // Number of missing soft-required clients
...
public:
    ...
    /**
     * Number of soft-required clients that are not in this solution. Unlike
     * missing required clients, missing soft-required clients do not make
     * the solution incomplete; they are penalised in the objective instead.
     */
    [[nodiscard]] size_t numMissingSoft() const;
